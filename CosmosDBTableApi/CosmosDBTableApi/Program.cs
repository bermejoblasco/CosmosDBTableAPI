...
namespace CosmosDBTableApi
{
    ...
    class Program
    {
        public static string tableName = "CompartiMOSS";

        static void Main(string[] args)
        {
            try
            {
                string connectionStringCosmosDB = "your cosmos connectionsring";
                string connectionStringAzureTableStorage = "your azure table storage";
